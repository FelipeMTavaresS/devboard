...
- **CI-Only Commits**: Commits are strictly prohibited unless the local CI flow passes 100%. This includes: `pnpm install`, `npx prisma generate`, `pnpm run lint`, `pnpm run test`, and `pnpm run build`.
